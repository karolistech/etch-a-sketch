...
const randomColorBtn = document.querySelector<HTMLButtonElement>(".controls__btn--randomize")!;
const eraseBtn = document.querySelector<HTMLButtonElement>(".controls__btn--erase")!;
...
function toggleGridLines() {
  ...
  canvas.classList.toggle("canvas--grid-lines", state.gridLines);
...
function setupEvents() {
  ...
  randomColorBtn.addEventListener("click", () => setMode("randomize"));
